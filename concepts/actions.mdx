...
<CardGroup cols={2}>
  <Card title="LLM Actions" icon="brain" href="/concepts/actions#llm-actions">
    Complete reference for language model actions
  </Card>
  <Card title="Code Execution" icon="code" href="/concepts/actions#code-execution">
    Guide to running code in your workflows
  </Card>
  <Card
    title="Memory Actions"
    icon="database"
    href="/concepts/actions#memory-actions"
  >
  ...
  <Card
    ...
    icon="plug"
    href="/concepts/actions#integration-actions"
  >
