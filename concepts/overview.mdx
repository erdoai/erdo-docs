...
<Accordion title="Security & Compliance">
  - Sandboxed code execution environment - Role-based access controls - Data
  encryption and privacy protection - Audit logging and compliance tracking
</Accordion>
...
<Tabs>
  ...
  <Tab title="Security">
    ...
    Control**: Use appropriate visibility settings - **Secret Management**:
    Secure API keys and credentials - **Audit Logging**: Track important actions
    and decisions
  </Tab>
</Tabs>
