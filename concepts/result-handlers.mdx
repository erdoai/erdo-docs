...
1. **Handle Both Success and Failure**: Always include error handlers
2. **Use Specific Conditions**: Be precise about when handlers should trigger
3. **Keep Actions Simple**: Avoid complex logic within handlers
4. **Test Edge Cases**: Verify handlers work with unexpected data
5. **Document Complex Conditions**: Make complex logic clear with comments
