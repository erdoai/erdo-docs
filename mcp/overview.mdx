...
| `dataset_slugs` | string[] | Optional. Datasets the page reads via `window.erdo.queryDataset` — the page is granted read access on each. |
...
| `dataset_slugs` | string[] | Optional. Replacement dataset list. |
