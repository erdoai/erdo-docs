...
Erdo exposes 26 MCP tools across five categories: data, threads, memory, artifacts, and automations.
...
All 26 tools work with scoped tokens. Each tool automatically scopes results to the resources the token has access to.
