...
Unit tests validate agent structure and logic without making LLM API calls:
...
Integration tests execute agents with real LLM calls, using replay mode for efficient test execution:
...
<CardGroup cols={2}>
  ...
  <Card title="SDK Testing" icon="code" href="/sdk/test">
