...
**See Also:**
- [Integration Testing](/testing/integration-tests) - Complete integration testing guide
- [Testing Overview](/testing/overview) - Learn about testing strategies
...
Execute an agent with messages and parameters directly from the CLI. Returns structured results following the executor pattern with clean separation of result, messages, steps, and events.
...
By default, `erdo invoke` outputs the agent's text response:
...
The invoke command follows the executor pattern with clean separation:
...
**See Also:**
- [SDK Invoke](/sdk/invoke) - Programmatic invoke() usage
- [Integration Testing](/testing/integration-tests) - Testing with invoke
...
# Set default model
erdo config set llm.default_model claude-sonnet-4-5
```
